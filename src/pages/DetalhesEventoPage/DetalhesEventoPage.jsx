...
import { DetailsEvent } from "../../components/NextEvent/NextEvent";
import { useParams } from "react-router-dom";
import Table from "./TableDeEvt/TableDeEvt";
...
const DetalhesEventosPage = () => {
    ...
    async function loadComentario() {
        ...
        try {
            const promiseAll = await api.get(commentaryResource + `?idEvento=${id}`)
            const promiseShow = await api.get(commentaryResource + `/ListarSomenteExibe?idEvento=${id}`)
